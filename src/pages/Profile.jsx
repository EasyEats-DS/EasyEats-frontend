...
import { UserRound, Mail, Phone, MapPin, Camera, Save, FileText, Bell, Lock, Clock, LogOut } from 'lucide-react';
  ...
  return (
    <UserLayout>
      <div className="max-w-4xl mx-auto p-4 space-y-8 animate-fade-in">
        ...
        {/* Profile Form */}
        <form onSubmit={handleSave} className="bg-white rounded-2xl shadow-md p-6 md:p-8 space-y-6">
